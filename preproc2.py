...
if __name__ == '__main__':
    ...
    create_vocabulary(vocab_path,
                      data_paths=[pjoin(args.source_dir, "train.contexts"),
                       pjoin(args.source_dir, "train.questions"),
                       pjoin(args.source_dir, "val.contexts"),
                       pjoin(args.source_dir, "val.questions")])
    ...
    x_train_dis_path = train_path + ".ids.contexts"
    y_train_ids_path = train_path + ".ids.questions"
    data_to_token_ids(train_path + ".contexts", x_train_dis_path, vocab_path)
    data_to_token_ids(train_path + ".questions", y_train_ids_path, vocab_path)

    x_dis_path = valid_path + ".ids.contexts"
    y_ids_path = valid_path + ".ids.questions"
    data_to_token_ids(valid_path + ".contexts", x_dis_path, vocab_path)
    data_to_token_ids(valid_path + ".questions", y_ids_path, vocab_path)